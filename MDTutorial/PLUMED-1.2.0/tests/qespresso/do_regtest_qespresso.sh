...
maxtasks=1
pw_prefix="/u/sbp/bussi/scratch/Plumed/all-codes/build/qespresso-4.1.2-parallel/bin/pw.x"
cp_prefix="/u/sbp/bussi/scratch/Plumed/all-codes/build/qespresso-4.1.2-parallel/bin/cp.x"
