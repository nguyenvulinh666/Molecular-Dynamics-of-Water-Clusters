...
c     iodine-iodine potential
      ...
      do i=1,maxgrd
        rrr=dble(i)*rpd
        rsq=rrr**2
        uuu(i,j)=14.39d0*(446.64d0/rrr**3-6.9331d0/rsq-2.3472d0)/rsq**2
        ggg(i,j)=14.39d0*(7.d0*446.64d0/rrr**3-6.d0*6.9331d0/rsq-
     x    4.d0*2.3472d0)/rsq**2
      enddo
      elrc(2)=14.39d0*(446.64d0/(4.d0*rcut**4)-6.9331d0/(3.d0*rcut**3)-
     x  2.3472d0/rcut)
      vlrc(2)=-14.39d0*(7.d0*446.64d0/(4.d0*rcut**4)-6.d0*6.9331d0/
