...
CMPIU      define MPI_FINALIZE MPI_FINALIZE_
      ...
      subroutine gisum_on_root(aaa,nnn,bbb)
      ...
      call MPI_reduce(aaa,bbb,nnn,MPI_INTEGER,
     x  MPI_SUM,0,MPI_COMM_WORLD,ierror)

      end subroutine gisum_on_root

      subroutine giscat(aaa,nnn,bbb)
      ...
      call MPI_scatter(aaa,nnn,MPI_INTEGER,bbb,nnn,MPI_INTEGER,
     x          0,MPI_COMM_WORLD,ierror)
      end subroutine giscat

      subroutine gdbcast(aaa,nnn)
      ...
      integer status(MPI_STATUS_SIZE)
        ...
        call MPI_Bcast
     $     (aaa,nnn,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierror)
