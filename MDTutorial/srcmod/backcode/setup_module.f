...
c     open the simulation input file
     ...
     x        findstring('reaction',record,idum))then
          ...
          elseif(findstring('generalized',record,idum)) then  ! GLE
            mxlgdof=intstr(record,69,idum)  
