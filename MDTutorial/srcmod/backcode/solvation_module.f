...
c***********************************************************************
      ...
      real(8) elrc2,virlrc2,engsic0,engsic2,elrc_sav
      real(8) virlrc_sav,volm_sav,elrc_fre,elrc_fre_sav
      real(8) qchg0,qchg1,qchg2,ang_fre,bnd_fre,dih_fre
      real(8) inv_fre,tbp_fre,fbp_fre,cou_fre,elrc2_sav
      real(8) vdw_fre,eng_cfg_fre,shl_fre,virlrc2_sav
      real(8) qchg_sav,qfix_fre
      ...
      real(8), allocatable :: qfix_exc(:),cou_exc_sic(:)
      real(8), allocatable :: weight_sav(:)
      
      save atmolt,rigid_sol,const_sol,lstgot_sol,natm_sol,elrc_sol,
     x  elrc_sol_sav,cou_sol,vdw_sol,bnd_sol,ckc_sol_sum,cks_sol_sum,
     x  cou_sol_sic,ebuf_sol1,en4_sol,ang_sol,dih_sol,en3_sol,
     x  qfix_sol,ebuf_sol2,shl_sol,vdw_sol_lng,cou_sol_lng,degfre_sol,
     x  degrot_sol,inv_sol,temp_sol,vxo_sol,vyo_sol,vzo_sol,
     x  mxtmls_sol2,mxtmls_sol3,mxtmls_sol4,lcomp
      
      save nfrn,ifrn,mfree,kfree,pfree,lambda1,lambda2,dlambda,
     x  eng_kin_fre,elrc2,virlrc2,engsic0,engsic2,elrc_sav,
     x  virlrc_sav,volm_sav,elrc_fre,elrc_fre_sav,qchg1,qchg2,
     x  ang_fre,bnd_fre,dih_fre,inv_fre,tbp_fre,fbp_fre,qchg0,
     x  cou_fre,vdw_fre,eng_cfg_fre,elrc2_sav,virlrc2_sav,qfix_fre
      save ind_fre,atm_fre,ckc1,cks1,ckc2,cks2,ckc_fre_sum,cks_fre_sum,
     x  ebuf_exc1,ebuf_exc2,vxo_fre,vyo_fre,vzo_fre,weight_sav
      
      save ntcons_ghost,ngrp_ghost,qchg_sav,nswitch,niswitch,
     x  mxtmls_exc2,mxtmls_exc3,mxtmls_exc4
      save cou_exc,vdw_exc,bnd_exc,ang_exc,dih_exc,en4_exc,vdw_exc_lng,
     x  cou_exc_lng,shl_exc,en3_exc,inv_exc,elrc_exc,elrc_exc_sav,
     x  qfix_exc,cou_exc_sic
...
c***********************************************************************
      ...
      if(lfree)elrc_fre=elrc_fre_sav*(volm_sav/volm)
...
c     open the FREENG file if new job or file closed
     ...
     x      nstep,eng_cfg_fre/engunit,eng_kin_fre/engunit
