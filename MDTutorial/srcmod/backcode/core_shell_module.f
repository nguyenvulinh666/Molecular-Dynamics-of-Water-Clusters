...
c***********************************************************************
      ...
      allocate (prmshl(mxtshl),stat=fail(1))
...
c***********************************************************************
     ...
     x       6x,'core',5x,'shell',6x,'parameter')")
      ...
      do ishls=1,numshl(itmols)
        ...
        prmshl(nshels)=dblstr(record,lenrec,idum)
...
c***********************************************************************
      ...
      real(8) engshl,virshl,rij,omega,gamma,ffx,ffy,ffz,strs

      dimension strs(6)
CVAM
CVAM      call VTBEGIN(26, ierr)
CVAM
