...
c*********************************************************************
      ...
      !! STOCH & GLE, read & fix cell's parameters
      if (.not. allocated(fixcell)) then
        ...
        close(666)
        write(nrite,*)  
     x  "Will multiply elements of cell accel. by"
        write(nrite,'(3f10.2)') fixcell(1:3)
        write(nrite,'(3f10.2)') fixcell(4:6)
        write(nrite,'(3f10.2)') fixcell(7:9)
      endif
...
c**********************************************************************
      ...
      call matmul(aaa,aaa,bbb)
      
      do i=1,9
        bbb(i)=uni(i)+aaa(i)+0.5d0*bbb(i)
      enddo
      
      call matmul(bbb,cell,cell)
