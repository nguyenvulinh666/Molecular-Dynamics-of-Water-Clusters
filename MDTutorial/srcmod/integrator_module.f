...
c***********************************************************************
     ...
     x  (lcnb,lshmov,idnode,mxnode,imcon,natms,ngrp,keyens,
...
c***********************************************************************
      ...
      logical safe,safep,safeq,lcnb,lshmov
      integer idnode,mxnode,imcon,natms,ngrp,keyens,nscons
      integer ntcons,ntpatm,ntfree,nspmf,ntpmf,mode
...
c     check on convergence of quaternion algorithm
     ...
     x  (lcnb,lshmov,isw,idnode,mxnode,imcon,natms,ngrp,keyens,
     x  nscons,ntcons,ntpatm,ntfree,nspmf,ntpmf,mode,tstep,engke,
...
c***********************************************************************
      ...
      logical safe,safep,lcnb,lshmov
