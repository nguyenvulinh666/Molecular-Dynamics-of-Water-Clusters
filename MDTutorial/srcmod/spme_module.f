...
CVAM
CVAM      call VTEND(129, ierr)
CVAM

      return
      end subroutine bspcoe

      subroutine bspgen(nospl,natms,txx,tyy,tzz)
...
c***********************************************************************
      ...
      integer npass,i,nnn,ipass,l,ll,k,kk,j,jj,fail
...
c     construct B-splines for atoms
      ...
      call bspgen(nospl,natms,txx,tyy,tzz)
