...
c***********************************************************************
      ...
      real(8), allocatable :: fsxx(:),fsyy(:),fszz(:)
...
c***********************************************************************
      ...
      allocate (fsxx(mxatms),stat=fail(28))
      allocate (fsyy(mxatms),stat=fail(29))
      allocate (fszz(mxatms),stat=fail(30))
